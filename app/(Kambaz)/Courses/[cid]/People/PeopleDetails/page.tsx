...
export default function PeopleDetails({ uid, onClose, fetchUsers }: { uid: string | null; onClose: () => void; fetchUsers: () => void; }) {
    ...
    return (
        <div className="wd-people-details position-fixed top-0 end-0 bottom-0 bg-white p-4 shadow w-25">
            ...
            {user && editing && (
                <select value={role} onChange={(e) => setRole(e.target.value)} className="form-select w-50 wd-edit-role">
